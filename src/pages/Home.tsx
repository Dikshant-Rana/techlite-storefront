...
import { ArrowRight, Download, Cpu, PhoneCall, Quote, ChevronLeft, ChevronRight, Search, FileText, CheckCircle2, Wrench, Phone, Camera, Monitor, Briefcase } from 'lucide-react';
    ...
    <>
      ...
      <div className="font-sans text-slate-900">
        ...
        <section className="homepage-hero relative w-screen bg-white overflow-hidden pt-30 pb-10 flex items-center ml-[calc(-50vw+50%)] mr-[calc(-50vw+50%)] bg-[size:40px_40px] bg-[linear-gradient(to_right,rgba(226,232,240,0.4)_1px,transparent_1px),linear-gradient(to_bottom,rgba(226,232,240,0.4)_1px,transparent_1px)] border-b border-slate-200/80">
          ...
          <div className="content-container w-full grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-6 flex flex-col items-start text-left ">
              ...
              {/* Paragraph Block */}
              <p className="text-sm sm:text-base md:text-lg text-slate-600 font-normal leading-relaxed max-w-2xl mb-5">
            ...
            <div className="lg:col-span-6 relative w-full min-h-0 lg:min-h-[450px] flex items-center justify-center mt-4 lg:mt-0 order-1 lg:order-2">
              {/* Primary collage image container */}
              <div className="w-full rounded-3xl overflow-hidden shadow-2xl border border-slate-100 bg-slate-50 relative z-20 group">
                <img
                  src={collageImg}
        ...
        <section className="py-16 w-screen ml-[calc(-50vw+50%)] mr-[calc(-50vw+50%)] overflow-hidden border-b border-slate-200/80 select-none">
          ...
          {/* Structural Headers */}
          <div className="content-container text-center space-y-3 mb-12">
                ...
                <div className="flex items-center gap-2">
                  {testimonials.map((_, idx) => (
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 ${activeTestimonialIdx === idx ? 'w-6 bg-[#066291]' : 'w-1.5 bg-slate-200 hover:bg-slate-300'
                        }`}
                    />
                  ))}
                </div>
