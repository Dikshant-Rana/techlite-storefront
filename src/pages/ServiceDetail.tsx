  ...
  return (
    <>
      ...
      <div className="font-sans text-slate-900 bg-white overflow-x-hidden">
        ...
        {/* 2. SERVICE OVERVIEW */}
        <section className="content-container py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        {service.technicians && service.technicians.length > 0 && (
          <section className="content-container py-20 border-t border-slate-100 space-y-12">
        ...
        <section className="content-container py-20 space-y-16">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-sky-50 border border-sky-100">
